...
class StartUpPage(tk.Canvas):
    def __init__(self, master, *args, **kwargs):
        ...
        tk.Label(self, text="Algoritmos de Alineamiento de Secuencias").grid(column=0, row=0)
        tk.Button(self, text="Neddleman-Wunch", command=lambda: master.switch_Canvas(PageOne)).grid(column=0, row=1)
        tk.Button(self, text="Smith-Waterman", command=lambda: master.switch_Canvas(PageTwo)).grid(column=0, row=2)
...
class PageOne(tk.Frame):
    def __init__(self, master, *args, **kwargs):
        ...
        tk.Button(self, text="Back", command=lambda: master.switch_Canvas(StartUpPage)).pack()
...
class PageTwo(tk.Frame):  # Sub-lcassing tk.Frame
    def __init__(self, master, *args, **kwargs):
        ...
        self.canvas = tk.Canvas(self, bg='yellow', width=600, height=400)
        ...
        self.label = tk.Label(self, text="Second page").pack(side="top", fill="x", pady=5)
        self.button = tk.Button(self, text="Back", command=lambda: master.switch_Canvas(StartUpPage))
        self.button.pack()
        self.canvas.pack(fill=tk.BOTH, side=tk.LEFT, expand=True)
